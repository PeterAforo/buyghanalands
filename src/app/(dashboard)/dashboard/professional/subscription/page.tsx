  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Choose the plan that fits your professional needs"
        breadcrumb={[
      ...
      {subscription && (
        <SectionCard className="border-emerald-200 bg-emerald-50">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="font-display text-base font-semibold text-emerald-950">
          ...
          return (
            ...
            >
              ...
              <div className="text-center">
                ...
                <h2 className="font-display text-base font-semibold text-emerald-950">{plan.name}</h2>
                <div className="mt-4">
