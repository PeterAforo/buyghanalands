...
export default function DisputesPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="My Disputes"
        breadcrumb={[{ label: "Dashboard", href: "/dashboard" }, { label: "Disputes" }]}
      />
      ...
      {disputes.length === 0 ? (
        <EmptyState
          ...
          title="No Disputes"
          description="You don't have any disputes. Disputes are created when there's an issue with a transaction."
        />
      ) : (
        <>
          {/* Active Disputes */}
          ...
          {resolvedDisputes.length > 0 && (
            <SectionCard title="Resolved Disputes">
              <div className="space-y-4">
