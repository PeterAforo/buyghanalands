    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          {/* Dispute Summary */}
          <SectionCard title="Dispute Summary">
          ...
          {dispute.resolution && (
            <SectionCard title="Resolution" className="border-emerald-200 bg-emerald-50">
          ...
          <SectionCard
            title="Discussion"
            description="Communicate with the other party and our support team"
          >
